            ...
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    var v = f.getFbeventsModules("SignalsFBEventsEventValidationConfigTypedef"),
                        ...
                        O = f.getFbeventsModules("SignalsFBEventsImagePixelOpenBridgeConfigTypedef"),
                ...
                (function() {
                    ...
                    function m(d) {
                        ...
                        if (s != null) {
                            ...
                            d != null && d.length > 0 && j(d, function(a) {
                                u.append("expv2[]", a)
                            })
        ...
        f.ensureModuleRegistered("signalsFBEventsSendEventImpl", function() {
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    function u(a, b) {
                        if (a.id != null && o("offsite_clo_beta_event_id_coverage", Number(a.id)) && a.eventName === "Lead" && a.customParams != null) {
                ...
                (function() {
                    j.exports = function(a) {
                        ...
                        var uc = {
                            ...
                            Fc = k.filter(Ka.split(S), function(a) {
                                return "a" !== a
                            }).join(S),
                            Gc = function a(b, c, d) {
                        ...
                        function Hc(a) {
                            return (Hc = "function" == typeof Symbol && "symbol" == G(typeof Symbol === "function" ? Symbol.iterator : "@@iterator") ? function(a) {
                                return G(a)
                            } : function(a) {
                                return a && "function" == typeof Symbol && a.constructor === Symbol && a !== (typeof Symbol === "function" ? Symbol.prototype : "@@prototype") ? "symbol" : G(a)
                            })(a)
                        ...
                        function gd(a) {
                            for (var b = {
                                ...
                                var d = a[c];
                                b.automaticParameters = hd(b.automaticParameters, d.automaticParameters), b.productContent = id(b.productContent, d.productContent), null != d.productID && null == b.productID && (b.productID = d.productID), null != d.productUrl && null == b.productUrl && (b.productUrl = d.productUrl)
                            }
                            return b
                        }
                        ...
                        function id(a, b) {
                            return null == a ? b : (null == b || (null != b.name && (a.name = b.name), null != b.description && (a.description = b.description), null != b.aggregate_rating && (a.aggregate_rating = b.aggregate_rating)), a)
                        }
                        ...
                        function md() {
                            var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                                ...
                                k = j.localProductID,
                                m = j.SKU;
                            rd(h, k, m), null == i.contents && (i.contents = []), i.contents.push(f), Bd(h.automaticParameters, a, i.contents);
                            var l = sd(d);
                            return {
                                    ...
                                    for (var q = {}, l = p.querySelectorAll("[itemprop]"), r = 0; r < l.length; r++) {
                                        ...
                                        if (!c.has(m)) {
                                            ...
                                            if ("string" == typeof s && "" !== s) {
                                                ...
                                                if (null != m && "" !== m) {
                                                    var n = q[s];
                                                    null != n && ed(k, s) ? Array.isArray(n) ? q[s].push(m) : q[s] = [n, m] : (null == e.productID && ("productID" === s ? h = m : "sku" === s && (o = m)), null == e.productUrl && "url" === s && (e.productUrl = m), a && pd(e, s, m), g && qd(f, e, s, m), q[s] = m)
                                                }
                                            }
                                        }
                                    }
                        ...
                        function pd(a, b, c) {
                            null == a.productContent.name && "name" === b && (a.productContent.name = c), null == a.productContent.description && "description" === b && (a.productContent.description = c), "ratingValue" !== b && "reviewCount" !== b || (null == a.productContent.aggregate_rating && (a.productContent.aggregate_rating = {}), "ratingValue" === b ? a.productContent.aggregate_rating.ratingValue = c : "reviewCount" === b && (a.productContent.aggregate_rating.reviewCount = c))
                        }

                        function qd(a, b, c, d) {
                            null == b.automaticParameters.currency && "priceCurrency" === c && (b.automaticParameters.currency = d), null != a.id || "productID" !== c && "sku" !== c || (a.id = d), null == a.mpn && "mpn" === c && (a.mpn = d), null == a.gtin && Y.includes(c) && (a.gtin = d), null == a.item_price && "price" === c && Z(a, "item_price", Cd(d)), null == a.availability && "availability" === c && (a.availability = Hd(d))
                        }
                            ...
                            var c = {},
                                d = function(a) {
                                    ...
                                    a = function(a) {
                                        ...
                                        if (null == a) return b;
                                        if (!Array.isArray(a)) return b.price = Cd($(a, Zc)), b.currency = $(a, $c), b;
                                        return 0 === a.length ? b : (Mc(a, function(a) {
                                            null != a.priceCurrency && (b.currency = $(a, $c)), b.price = function(a, b) {
                                                if (null == a) return b;
                                ...
                                e = $(a, Uc, b.mpn),
                                f = $(a, Y, b.gtin);
                            return Z(c, "mpn", e), Z(c, "gtin", f), Z(c, "item_price", d.price), Z(c, "availability", Hd($(a, Yc))), {
                                content: kd(c, function(a, b) {
                        ...
                        function vd() {
                            for (var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], b = arguments.length > 2 ? arguments[2] : void 0, c = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], d = {
                                ...
                                var q = h[k],
                                    l = q.innerText;
                                if (null != l && "" !== l) try {
                                    if ((i += l.length) > 12e4) return Bd(d.automaticParameters, a, j), {
                                    ...
                                    for (var r = wd(l), m = 0; m < r.length; m++) {
                                        var s = r[m];
                                        zd(r, $(s, ["mainentity"])), zd(r, $(s, ["@graph"])), zd(r, $(s, ["hasvariant"]));
                                        var n = {},
                                            t = xd({
                                                json: s,
                                                productMetadata: d,
                            ...
                            return Bd(d.automaticParameters, a, j), {
                                extractedProperties: e,
                                invalidInnerTexts: f,
                                productMetadata: d
                            }
                        ...
                        function wd(a) {
                            var b = null;
                            return b = Kd(a), b = JSON.parse(b.replace(/[\n\r\t]+/g, " ")), Array.isArray(b) || (b = [b]), b
                        }
                        ...
                        function xd(a) {
                            ...
                            if (g) {
                                ...
                                e && (Z(d, "id", h), Z(d, "mpn", $(b, Uc)), ud(b, a), Z(d, "gtin", $(b, Y))), null != c.productUrl && "" !== c.productUrl || !b.url || (c.productUrl = b.url)
                            }
                            return {
                                isTypeProduct: g,
                                offers: $(b, bd)
                        ...
                        function yd(a) {
                            var b = a.offers,
                                ...
                                f = a.logInfo,
                                g = [];
                            if (Array.isArray(b) && b.length > 0) Mc(b, function(a) {
                                if (null == c.productUrl && a.url && (c.productUrl = a.url), e) {
                                    var b = td(a, d);
                                    ud(a, f), null == c.automaticParameters.currency && (c.automaticParameters.currency = b.currency), g = g.concat(b.content)
                                }
                            });
                            else {
                                a = Ad(b);
                                ...
                                if (null == c.productUrl && h && b.url && (c.productUrl = b.url), (h || a) && e) {
                                    h = td(b, d);
                                    ud(b, f), null == c.automaticParameters.currency && (c.automaticParameters.currency = h.currency), g = g.concat(h.content)
                                }
                            }
                            return g
                        }
                        ...
                        function Dd(a, b, c) {
                            null != c.productContent.name || "product:name" !== a && "og:title" !== a || (c.productContent.name = b), null != c.productContent.description || "product:description" !== a && "og:description" !== a || (c.productContent.description = b)
                        }
                        ...
                        function Ed(a, b, c, d) {
                            ...
                            }).includes(a) && (d.gtin = b), null != d.item_price || "product:price:amount" !== a && "og:price:amount" !== a || Z(d, "item_price", Cd(b)), null != d.availability || "product:availability" !== a && "og:availability" !== a || (d.availability = Hd(b))
                        }
                        ...
                        function Fd(a, b, c, d, e, f) {
                            var g = arguments.length > 6 && void 0 !== arguments[6] && arguments[6],
                                ...
                                i = null,
                                j = c[a];
                            return null != j && dd(a) ? Array.isArray(j) ? c[a].push(b) : c[a] = [j, b] : (b && (null != d.productID && "" !== d.productID || ("product:retailer_item_id" === a && (h = b), "product:sku" === a && (i = b)), null != d.productUrl && "" !== d.productUrl || "og:url" !== a || (d.productUrl = b), g && Dd(a, b, d), f && Ed(a, b, d, e)), c[a] = b), {
                        ...
                        function Gd() {
                            for (var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], b = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], c = {
                                    ...
                                    productUrl: null,
                                    productContent: {}
                                }, d = new Oc(["og", "product", "music", "video", "article", "book", "profile", "website", "twitter"]), e = {}, f = null, h = null, i = {}, j = g.querySelectorAll("meta[property]"), k = 0; k < j.length; k++) {
                                var n = j[k],
                                ...
                                if ("string" == typeof l && -1 !== l.indexOf(":") && "string" == typeof o && d.has(l.split(":")[0])) {
                                    var m = R(o, 500),
                                        p = Fd(l, m, e, c, i, a, b);
                                    p.productRetailerItemID && (f = p.productRetailerItemID), p.productSKU && (h = p.productSKU)
                                }
                            }
                            return null != f ? c.productID = f : null != h && (c.productID = h), Bd(c.automaticParameters, a, [i]), {
                                extractedProperties: e,
                                productMetadata: c
                            }
                        }
                        ...
                        function Jd() {
                            ...
                            for (var d = g.querySelectorAll("meta[name]"), e = 0; e < d.length; e++) {
                                ...
                                "string" == typeof h && "string" == typeof i && Id[h] && (c["meta:" + h] = R(i, 500))
                            }
                            return c
                        }
                ...
                (function() {
                    ...
                    function ya(d) {
                        ...
                        switch (d) {
                            ...
                            case "autoConfig":
                                ...
                                typeof n === "string" ? Y.callMethod([o, n, "AutomaticSetup"]) : n === void 0 ? Y.disableAutoConfig = o === "optOut" : Q({
                            ...
                            case "firstPartyCookies":
                                ...
                                typeof r === "string" ? Y.callMethod([s, r, "FirstPartyCookies"]) : r === void 0 ? Y.disableFirstPartyCookies = s === "optOut" : Q({
                                    invalidParamName: "pixel_id",
                                    invalidParamValue: r,
                                    method: "set",
                                    params: h,
                            ...
                            case "openbridge":
                                var E = f[0],
                                    F = f[1];
                                E !== null && F !== null && typeof E === "string" && typeof F === "string" && (Y.callMethod(["optIn", E, "OpenBridge"]), Y.pluginConfig.set(E, "openbridge", {
                                    endpoints: [{
                                        endpoint: F
                                    }]
                                }));
                            ...
                            case "trackSingleOnly":
                                ...
                                qa.call(X, J) ? X[J].trackSingleOnly = I : Q({
                                    metadataValue: d,
                                    pixelID: J,
                            ...
                            case "userData":
                                ...
                                break;
                            default:
                                var S = Y.pluginConfig.getWithGlobalFallback(null, "dataProcessingOptions"),
                    ...
                    function za(a, b, c) {
                        try {
                            ...
                            a = A.eval("send_censored_ph", d) || A.eval("send_censored_em", d);
                            var f = {};
                            e && a && (f = ia(b || {}));
                            a = null;
                            b != null && (a = i({}, b), b = M(b), b = oa(b), b = N(b));
                            if (qa.call(X, d)) {
                                b != null && C(X[d].userData) ? (X[d].userData = e ? b || {} : {}, X[d].alternateUserData = e ? a || {} : {}, X[d].censoredUserDataFormat = f, Z.loadPlugin("identity")) : Q({
                                    pixelID: d,
                    ...
                    function Ca(a, b, c) {
                        b = b || {}, q.validateEventAndLog(a, b), a === "CustomEvent" && typeof b.event === "string" && (a = b.event), Da.call(this, a, b, c)
                    }
                    ...
                    function Da(b, c, e) {
                        ...
                        try {
                            A.eval("reset_init_time_on_spa_page_change") && f.isAutomaticPageView && (S = S !== -1 ? Date.now() : S);
                            for (var k = 0, l = W.length; k < l; k++) {
                                var m = W[k],
                                    n = Date.now().toString(),
                                    o = g.fbq.instance.pluginConfig.get(m.id, "buffer"),
                                    p = !1;
                                o != null && (p = o.onlyBufferPageView === !0 && O.isInTest("spa_pageview_fix"));
                                p = f.allowDuplicatePageViews || p;
                                f.isAutomaticPageView && (e = i(i({}, e), {}, {
                                    isAutomaticPageView: !0
                                }));
                                if (!(b === "PageView" && p) && Object.prototype.hasOwnProperty.call(ua, b) && ua[b].has(m.id)) continue;
                    ...
                    function Fa(a, b, c, d, e) {
                        c = Ga(a, c, e), q.validateEventAndLog(b, c), b === "CustomEvent" && typeof c.event === "string" && (b = c.event), Da.call(this, b, c, d)
                    }
                    ...
                    function Ma(a) {
                        ...
                        if (c != null && (c.eventID != null || c.event_id != null)) {
                            ...
                            var i = c.event_id;
                            f = f != null ? f : i;
                            f == null && (b.event_id != null || b.eventID != null) && p.consoleWarn("eventID is being sent in the 3rd parameter, it should be in the 4th parameter.");
                            g.containsKey("eid") ? f == null || f.length == 0 ? p.logError(new Error("got null or empty eventID from 4th parameter")) : g.replaceEntry("eid", f) : g.append("eid", f)
                        }
                        ha.trigger({
                            pixelID: e ? e.id : null,
                            eventName: d,
                    ...
                    function Sa(a) {
                        a.instance = Y, a.callMethod = xa, a._initHandlers = [], a._initsDone = {}, a.send = Ia, a.getEventCustomParameters = Ja, a.addInitHandler = Qa, a.getState = Ra, a.init = za, a.set = ya, a.loadPlugin = function(a) {
